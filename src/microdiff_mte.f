C $$$$$$
      SUBROUTINE MICRODIFF_MTE(NLIGHT,CSLIGHT,HCOMP,HQPR,HRU,HS1,IBEGIN,  ! HTU
     *               IEND,M,DR,NPT,ODEN,OTEM,EM,ER,EDEN,ETEM,EHQPR,EDELR,  ! LC
...
C MHP 3/94 ADDED METAL DIFFUSION.
     ...
     *       LOCONS(JSON),SO(JSON),SDEL(3,JSON),SFXION(3,JSON),SVEL(JSON)
      DIMENSION HCOMP(15,JSON),HQPR(JSON),HRU(JSON),HS1(JSON),  ! HTU(JSON)
