...
C SETUP NUCLEAR ENERGY TERMS
         CALL RATES(DL,TL,X,Y,XHE3,XC12,XC13,XN14,  ! Z,XN15,XO17
     *        XO16,XO18,I,HR1,HR2,HR3,HR4,  ! XH2,XLI6,XLI7,XBE9
     *        HR5,HR6,HR7,HR8,HR9,HR10,HR11,HR12,HR13,HF1,HF2)
C MHP 5/02 COMPUTE RATE FOR DEUTERIUM BURNING
         IF(XH2TEST.GT.1.0D-11)THEN
            CALL DEUTRATE(DL,TL,X,I,ITLVL)  ! XH2
         ELSE
            DRATE(I) = 0.0D0
         ENDIF
   10 CONTINUE
...
C EXIT LOOP ONCE T DROPS BELOW NUCLEAR REACTION T CUTOFF
     ...
     *           HR7,HR8,HR10,HR11,HR12,HF1,HS2,HCOMP,  ! HR9,HR13
     *           DDAGE)  ! ITLVL
   30    CONTINUE
   40 CONTINUE
   45 CONTINUE
...
C EXIT LOOP ONCE T DROPS BELOW NUCLEAR REACTION T CUTOFF
               ...
               IBEGIN = J
               IEND = J
               CALL EQBURN(HR1,HR2,HR3,HR4,HR5,HR6,HR7,  ! HF1,HR8,HR9
     *              HR10,HR12,HS2,HT,IBEGIN,IEND,  ! HR11
